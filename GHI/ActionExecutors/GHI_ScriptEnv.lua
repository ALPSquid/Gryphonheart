...
function GHI_ScriptEnviroment(ownerGuid)
	...
	local environment = {
		...
		GetMapLandmarkInfo = GHI_Position().GetMapBannerInfo,
		GetMapOverlayInfo = GHI_Position().GetMapTextureInfo,
		GetMapZones = GHI_Position().GetZonesForContinentByIdx,
		GetNumMapLandmarks = GHI_Position().GetNumMapBanners,
		GetNumMapOverlays = GHI_Position().GetNumMapTextures,
		GetPlayerMapPosition = GHI_Position().GetPlayerMapPosition,
		--ProcessMapClick = ProcessMapClick,
		RequestBattlefieldPositions = GHI_Position().GetPartyPlayerPositions,
		SetDungeonMapLevel = GHI_Position().SetMapSubLevel,
